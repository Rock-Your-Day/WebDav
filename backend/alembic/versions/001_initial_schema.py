...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("auth_provider", sa.Enum("local", "oidc", name="auth_provider_enum"), nullable=False, server_default="local"),
        sa.Column("oidc_subject", sa.String(255), nullable=True),
        sa.Column("role", sa.Enum("admin", "user", "readonly", name="role_enum"), nullable=False, server_default="user"),
    ...
    op.create_table(
        ...
        sa.Column("provider_type", sa.Enum("local", "s3", "nfs", "azure", name="provider_type_enum"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("storage_id", sa.String(36), sa.ForeignKey("storage_destinations.id", ondelete="CASCADE"), nullable=False),
        sa.Column("permission", sa.Enum("read", "write", "admin", name="permission_enum"), nullable=False, server_default="read"),
    ...
    op.create_table(
        ...
        sa.Column("storage_id", sa.String(36), sa.ForeignKey("storage_destinations.id", ondelete="SET NULL"), nullable=True),
        sa.Column("action", sa.Enum("upload", "download", "delete", "mkdir", "move", "copy", name="action_enum"), nullable=False),
