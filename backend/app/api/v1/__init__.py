...
from app.api.v1 import activity, auth, filesystem, oidc, reports, sla, storage, users, versions
...
router.include_router(oidc.router, prefix="/oidc", tags=["OIDC Configuration"])
